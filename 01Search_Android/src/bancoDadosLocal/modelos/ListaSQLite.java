...
public class ListaSQLite extends OperacaoGenerica<Lista> {

	private static ListaSQLite listaSQLite;

	private Context context;

	public static ListaSQLite get(Context context) {
		if (listaSQLite == null)
			listaSQLite = new ListaSQLite(context);

		return listaSQLite;
	}

	public ListaSQLite(Context context) {
		super(context);
	...
	protected Lista preencheCursor(Cursor c) throws Exception {

		Lista lsita = new Lista();
